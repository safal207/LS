...
- Hook API parity is implemented in `rust_core/src/web4_runtime.rs` for `Web4RttBinding`
  (`register_*`, `unregister_*`, `clear_session_hooks`).
...
- Rust bridge behavior is covered in `python/tests/test_rust_bridge.py`.
