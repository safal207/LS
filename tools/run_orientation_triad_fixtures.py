#!/usr/bin/env python3
"""Materialize, validate, and execute Orientation Triad conformance fixtures."""
...
from evaluate_orientation_triad import evaluate
    ...
    for fixture_path in args.fixtures:
        ...
        for case in materialize(payload):
            ...
            input_case = {
                ...
                if key not in {"fixture_id", "expected"}
            }
            schema_errors = sorted(
                validator.iter_errors(input_case),
            ...
            if (
                ...
                or result["downstream_gates_required"] is not True
            ):
                failures.append({
                    "fixture_file": str(fixture_path),
                    "fixture_id": case.get("fixture_id", "unknown"),
                    ...
                    "actual": {
                        ...
                        "downstream_gates_required": result["downstream_gates_required"],
                    },
                })
