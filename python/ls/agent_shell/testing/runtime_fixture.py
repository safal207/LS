...
class FixtureRuntime:
    """Test-only runtime implementing the TaskRuntime protocol.

    Persists JSON to disk so tests can validate restart behavior without
    introducing a production runtime implementation in MCP layer.
    """

    def __init__(self, state_path: str | Path = ".ls_agent/test-runtime/state.json", artifact_root: str | Path = ".ls_agent/test-runtime/artifacts") -> None:
    ...
    def plan_task(self, *, prompt: str, mode: str) -> dict[str, Any]:
        ...
        self._state["tasks"][task_id] = {
            ...
            "summary": None,
            "steps": [step],
            "events": [{"level": "info", "step_id": step["id"], "message": f"Plan generated for {task_id}", "created_at": "fixture"}],
            "artifacts": [],
        }
        self._save()
    ...
    def run_task(self, *, prompt: str, mode: str) -> dict[str, Any]:
        ...
        self._state["tasks"][task_id] = {
            ...
            "summary": None,
            "steps": steps,
            "events": [{"level": "info", "step_id": steps[2]["id"], "message": f"Approval required for {steps[2]['id']}", "created_at": "fixture"}],
            "artifacts": [],
        }
        self._save()
    ...
    def approve(self, *, task_id: str, step_id: str) -> dict[str, Any]:
        ...
        artifact = {
            ...
            "title": "Task report",
            "type": "report",
            "path_or_url": str(self.artifact_root / task_id / "report.md"),
        }
...
def build_fixture_runtime() -> FixtureRuntime:
