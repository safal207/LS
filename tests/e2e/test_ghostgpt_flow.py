...
class TestGhostGPTFlow(unittest.TestCase):
    def test_instantiation(self):
        import importlib

        ghost_main = importlib.import_module("apps.ghostgpt.main")
        self.assertTrue(hasattr(ghost_main, "GhostGPT"))
        ghost = ghost_main.GhostGPT()
        ghost.set_lri_mode("HR")
        ghost.toggle_visibility()
        self.assertTrue(hasattr(ghost_main, "cfg"))
