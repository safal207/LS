...
export default function Roadmap() {
  ...
  const captions = {
    ...
    ru: [
      'Первый продаваемый сценарий: агент предлагает ответ, LS показывает риск, человек быстро принимает решение.',
      'Главный актив продукта: история решений превращается в память, которая улучшает следующие ответы.',
      'Переход от одной машины к личной среде: контекст следует за человеком, а не за отдельным чатом.',
      'Масштабирование категории: проверка, память, качество и координация подключаются как рабочие модули.'
    ]
  } as const;
