...
- **Metabolism & Consolidation**: Слой метаболизма (`MetabolismEngine`) для переработки когнитивных "отходов" в `nutrient_pool`.
...
## Model Support
- **Qwen3.5 Small Series Ready**: Подготовка к интеграции моделей Qwen3.5 (0.8B, 1.5B, 7B).
